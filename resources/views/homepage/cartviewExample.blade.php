                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-1">
                                            <span class="original-price"
                                                style="text-decoration: line-through; margin-right: 8px; color: rgb(125, 132, 125); ">
                                        ...
                                        <p class="discount-amount" id="discountAmount{{ $item->id }}"></p>
                    ...
                    <div class="card bg-light p-4 rounded">
                        ...
                        <div class="price-details">
                            ...
                            <div class="discount-details">
                                <h6>Discount</h6>
                                <h6 class="amount" style="color: rgb(66, 165, 66);">−
                                    {{-- ₹{{ $item->product->original_price - $item->product->selling_price }}</h6> --}}
                                    <p class="amount"></p>-₹{{ $totalDiscount }}</p>
                            ...
                            <div>
                                {{-- <h6 class="amount" style="color: rgb(66, 165, 66);">
                                         You will save
                                        ₹{{ $item->product->original_price - $item->product->selling_price + 40 }} on this
                                        order</h6> --}}
                                <p>You will save ₹<span id="overallSavings">{{ $totalDiscount + 40 }}</span> on this order
                                </p>
    ...
    $(document).ready(function() {
        ...
        function updateTotalPrice() {
            ...
            $('.quantity-input').each(function() {
                let qty = parseInt($(this).val()) || 0; // If it's not a number, default to 0
                let price = parseFloat($(this).data('price')) || 0; // Default to 0 if price isn't set
                total += qty * price;
            });
            ...
            // Update the price for one item
            $("#pricePerItem").text("₹" + total.toFixed(2));
        }
    ...
    $(document).ready(function() {
        ...
        function updateTotalPrice() {
            ...
            $('.quantity-input').each(function() {
                ...
                // If the quantity is more than 1, update the original price
                if (qty > 1) {
                ...
                let discountAmount = price - originalPrice;
                totalDiscount += qty * discountAmount;
